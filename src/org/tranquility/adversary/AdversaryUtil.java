...
public class AdversaryUtil {
    public static final String FACTION_ADVERSARY = Global.getSettings().getString("adversary", "faction_id_adversary");

    public static final String MOD_ID_ADVERSARY = Global.getSettings().getString("adversary", "mod_id_adversary"); // For LunaLib
